...
/**
 * Server Setup Script
 * Upload this to your PUBLIC folder and visit: https://itzrenzo.dev/setup.php
...
// Load Laravel (we're in /public, so go up one level)
...
echo "\n⚠️  IMPORTANT: DELETE THIS FILE (setup.php) FROM PUBLIC FOLDER FOR SECURITY!\n";
